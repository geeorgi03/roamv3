...
export default function ShareSheet({ isOpen, onClose, clipId, sessionId }: ShareSheetProps) {
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-1">
              <div className="flex items-center gap-2">
                ...
                <p style={{ fontFamily: "var(--font-app-title)", fontWeight: 600, fontSize: "16px", color: "var(--text-primary)" }}>Link copied</p>
              </div>
