...
export default function NotePinSheet({
  isOpen,
  timecode,
  sectionName,
  onClose,
      ...
      >
        ...
        <div className="px-5 py-4">
            ...
            >
              {mode === "recorded" ? (
                ...
                <Mic
                  className="w-8 h-8"
                  style={{
                    color: mode === "recording" ? "#FF3B30" : "var(--text-secondary)",
                  }}
                />
              )}
          ...
          <div className="flex items-center gap-3 my-3">
            ...
            <span style={{ fontFamily: "var(--font-body)", fontSize: "11px", color: "var(--text-disabled)" }}>
              or type
            </span>
            <div className="flex-1 h-px" style={{ backgroundColor: "var(--border-subtle)" }} />
          </div>
        ...
        <div className="px-5 pb-8 flex gap-3">
          ...
          <button
            ...
            style={{
              backgroundColor:
                mode === "recording" || (mode === "idle" && !textNote.trim())
                  ? "var(--surface-overlay)"
                  : "var(--accent-primary)",
              fontFamily: "var(--font-body)",
              fontSize: "14px",
