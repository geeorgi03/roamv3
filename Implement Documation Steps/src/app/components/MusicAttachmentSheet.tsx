...
export default function MusicAttachmentSheet({
  ...
  const handleUrlPaste = async (value: string) => {
    ...
    const isValidUrl = value.includes('spotify.com') || 
    ...
    setTimeout(() => {
      // Mock success (in real app, this would call a backend API)
      ...
      if (mockSuccess) {
        ...
        setState({
          type: 'error',
          message: "This track couldn't be imported.",
        });
      }
    }, 1500);
  };
  ...
  const handleFileSelect = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    // In real app, extract metadata from audio file
    onConfirm({ type: 'file', value: file });
    handleClose();
  };
        ...
        <div className="px-6 pb-6">
          ...
          {state.type === 'preview' && (
            <div className="space-y-6">
              ...
              <div 
                className="h-12 rounded flex items-center gap-0.5 px-2"
                style={{
                  backgroundColor: 'var(--surface-base)',
                }}
              >
